  ...
  Widget medicineList() {
    return StreamBuilder(
        stream: Firestore.instance
            .collection("medicines").where("isMedicine",isEqualTo: true)
            .snapshots(),
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
        ...
        child: Scaffold(
          ...
          body : Container(child: medicineList()),
...
class ExpandableListMedicine extends StatefulWidget {
  final String name;
  final String company;
  final int price;
  final int discount;
  final String description;
  ExpandableListMedicine(this.name, this.company,this.price,this.discount,this.description);

  @override
  _ExpandableListMedicineState createState() => _ExpandableListMedicineState();
}

class _ExpandableListMedicineState extends State<ExpandableListMedicine> {
